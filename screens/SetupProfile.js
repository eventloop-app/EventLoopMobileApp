...
const SetupProfile = (props) => {
    ...
    const [data, setData] = useState(
        {
            ...
            firstname: authInfo?.name.split(' ')[0].toLowerCase(),
            lastname: authInfo?.name.split(' ')[1].toLowerCase(),
    ...
    useEffect(()=>{
        setData({...data, deviceId: token.token})
    },[token])
    ...
    const renderForm = () => (
        <View style={{marginTop: 10}}>
            <View>
                ...
                {
                    (error.username && data.username?.length > 0) && <Text style={{
                        fontFamily: Fonts.primary,
                        fontSize: FontSize.vary_small,
                        marginTop: 5,
                        color: Colors.red
                    }}>ชื่อผู้ใช้ไม่ถูกต้องหรือถูกใช้งานไปแล้ว</Text>
                }
            </View>
                ...
                <ProgressSteps labelFontFamily={Fonts.primary}>
                    <ProgressStep
                        ...
                        nextBtnTextStyle={{
                            ...
                            color: error.username ? Colors.gray2 : Colors.primary
                        }}>
                    ...
                    <ProgressStep
                        ...
                        nextBtnTextStyle={{
                            fontFamily: Fonts.bold,
                            color: data.tags.length > 0 ? Colors.primary : Colors.gray2
                        }}
                    >
                        <View style={{alignItems: 'center', height: 500}}>
                            {
